...
export default function CanadaCoverageStudy(){
  ...
  return <main className="or-industries-study">
    <header className="or-industries-header"><Link href="/">ORAGROL <small>GLOBAL</small></Link><p>INDUSTRIES + CANADA</p><Link href="/">Return to homepage ↗</Link></header>
    <section className="or-industries-stage">
      <div className="or-mass" aria-hidden="true">OR</div>
      <div className="or-section-title"><span>BUILT AROUND YOUR REALITY</span><h1>Different businesses.<br/>Different risks.</h1></div>
      ...
      <article className="r-content" key={industries[active].name}><div className="r-canada"><span className="r-flag"><i>◆</i></span><p>CANADA-WIDE<br/>PERSPECTIVE</p></div><p className="r-selected">{industries[active].name}</p><h2>{industries[active].risk}</h2><Link href="/industries">Explore this industry ↗</Link><div className="r-reach"><span>WEST</span><i/><span>CENTRAL</span><i/><span>EAST</span><i/><span>NORTH</span></div></article>
