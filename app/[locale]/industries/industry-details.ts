...
export const industryDetails: Record<string, IndustryDetail> = {
  "Professional Services": {
    ...
    automate: ["Sales for referrals, proposals and engagement follow-up.","Secure client intake with document-status tracking and approved onboarding steps.","Finance for capacity, work in progress, billing and client-service visibility."],
  ...
  Healthcare: {
    ...
    automate: ["Approved reminders, intake status and non-clinical follow-up with staff escalation.","Administrative intake that checks completeness without automating clinical decisions.","IT for endpoint health, tickets, device lifecycle and recurring access work."],
  ...
  "Financial Services": {
    ...
    automate: ["Compliance workflow support for evidence, review, exceptions and approvals.","Controlled client onboarding with required human review.","Finance for authorized pipeline, service, exception and risk views."],
  ...
  "Retail & E-commerce": {
    ...
    automate: ["Customer Service for approved answers, routing and human escalation.","Marketing for consent-aware post-purchase, loyalty and reactivation journeys.","Finance for inventory, fulfilment, returns and campaign visibility."],
  ...
  Manufacturing: {
    ...
    automate: ["IT for endpoints, access, service requests and recurring evidence.","Finance for authorized inventory, quality, downtime and supplier indicators.","Supplier workflows for approvals, evidence, expiry dates and exceptions."],
  ...
  Technology: {
    ...
    automate: ["Sales for demand, qualification, proposals and handoff.","Customer Service for approved knowledge, routing and escalation.","Finance for product, service, customer and revenue indicators."],
  ...
  "Construction & Real Estate": {
    ...
    automate: ["Sales for enquiries, appointments, proposals and long-cycle follow-up.","Project intake for approved documents, missing items, routing and status.","IT for distributed devices, accounts and recurring service work."],
  ...
  Education: {
    ...
    automate: ["Approved routine information and support with escalation to staff.","Admissions administration for document status, reminders and authorized handoffs.","IT for devices, accounts, tickets and access work."],
  ...
  "Other Canadian SMBs": {
    ...
    automate: ["Sales workflows so enquiries and proposals do not go cold.","Customer Service for consistent routing, answers and escalation.","Finance for governed, current reporting.","IT for routine devices, accounts, tickets and access."],
